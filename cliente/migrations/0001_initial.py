    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_abertura', models.DateField(default=datetime.datetime(2023, 8, 21, 8, 54, 59, 7796))),
                ('status_conta', models.CharField(max_length=12)),
                ('chave_pix', models.CharField(blank=True, max_length=50, null=True, unique=True)),
